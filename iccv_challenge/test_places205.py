...
def load_json(file_path):
    ...
    img_labels = np.array(list(data.values())).astype(np.int32)
...
def main():
    ...
    targets_file = os.path.join(curr_dir, 'places205', 'val_img_labels.json')
    ...
    test_places205(targets, predictions)
